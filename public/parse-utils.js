...
function splitIntoFoodItems(text) {
    ...
    parts = parts.flatMap(part => {
        return part.split(/[と]/).map(p => p.trim()).filter(p => p);
    });
